...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.quantity'
        db.alter_column(u'ils_record', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Record.quantity'
        db.alter_column(u'ils_record', 'quantity', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

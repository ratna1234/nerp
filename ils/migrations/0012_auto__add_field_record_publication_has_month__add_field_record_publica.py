...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.publication_has_month'
        db.add_column(u'ils_record', 'publication_has_month',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Record.publication_has_day'
        db.add_column(u'ils_record', 'publication_has_day',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.publication_has_month'
        db.delete_column(u'ils_record', 'publication_has_month')

        # Deleting field 'Record.publication_has_day'
        db.delete_column(u'ils_record', 'publication_has_day')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.format'
        db.alter_column(u'ils_record', 'format', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Record.format'
        db.alter_column(u'ils_record', 'format', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

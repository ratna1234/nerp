...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field published_places on 'Record'
        m2m_table_name = db.shorten_name(u'ils_record_published_places')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('record', models.ForeignKey(orm[u'ils.record'], null=False)),
            ('place', models.ForeignKey(orm[u'ils.place'], null=False))
        ))
        db.create_unique(m2m_table_name, ['record_id', 'place_id'])


    def backwards(self, orm):
        # Removing M2M table for field published_places on 'Record'
        db.delete_table(db.shorten_name(u'ils_record_published_places'))

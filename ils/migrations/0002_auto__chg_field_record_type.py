...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ils_record', 'type', self.gf('django.db.models.fields.CharField')(unique=True, max_length=11))

    def backwards(self, orm):

        # Changing field 'Record.type'
        db.alter_column(u'ils_record', 'type', self.gf('django.db.models.fields.IntegerField')(unique=True))

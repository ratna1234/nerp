...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ils_bookfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('record', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['ils.Record'])),
        ))
        db.send_create_signal(u'ils', ['BookFile'])


    def backwards(self, orm):
        # Deleting model 'BookFile'
        db.delete_table(u'ils_bookfile')

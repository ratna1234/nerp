...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.openlibrary_id'
        db.alter_column(u'ils_record', 'openlibrary_id', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Record.openlibrary_id'
        db.alter_column(u'ils_record', 'openlibrary_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.lcc'
        db.add_column(u'ils_record', 'lcc',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.ddc'
        db.add_column(u'ils_record', 'ddc',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.lcc'
        db.delete_column(u'ils_record', 'lcc')

        # Deleting field 'Record.ddc'
        db.delete_column(u'ils_record', 'ddc')

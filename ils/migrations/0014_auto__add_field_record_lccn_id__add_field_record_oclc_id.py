...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.lccn_id'
        db.add_column(u'ils_record', 'lccn_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.oclc_id'
        db.add_column(u'ils_record', 'oclc_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.lccn_id'
        db.delete_column(u'ils_record', 'lccn_id')

        # Deleting field 'Record.oclc_id'
        db.delete_column(u'ils_record', 'oclc_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.weight'
        db.add_column(u'ils_record', 'weight',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.dimensions'
        db.add_column(u'ils_record', 'dimensions',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.weight'
        db.delete_column(u'ils_record', 'weight')

        # Deleting field 'Record.dimensions'
        db.delete_column(u'ils_record', 'dimensions')

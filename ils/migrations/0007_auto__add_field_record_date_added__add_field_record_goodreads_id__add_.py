...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.date_added'
        db.add_column(u'ils_record', 'date_added',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Adding field 'Record.goodreads_id'
        db.add_column(u'ils_record', 'goodreads_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.librarything_id'
        db.add_column(u'ils_record', 'librarything_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Record.openlibrary_id'
        db.add_column(u'ils_record', 'openlibrary_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.date_added'
        db.delete_column(u'ils_record', 'date_added')

        # Deleting field 'Record.goodreads_id'
        db.delete_column(u'ils_record', 'goodreads_id')

        # Deleting field 'Record.librarything_id'
        db.delete_column(u'ils_record', 'librarything_id')

        # Deleting field 'Record.openlibrary_id'
        db.delete_column(u'ils_record', 'openlibrary_id')
    ...
    models = {
        ...
        u'ils.record': {
            ...
            'openlibrary_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),

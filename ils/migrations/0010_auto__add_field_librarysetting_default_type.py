...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LibrarySetting.default_type'
        db.add_column(u'ils_librarysetting', 'default_type',
                      self.gf('django.db.models.fields.CharField')(default='circulative', unique=True, max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LibrarySetting.default_type'
        db.delete_column(u'ils_librarysetting', 'default_type')

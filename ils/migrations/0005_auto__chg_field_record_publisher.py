...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Record.publisher'
        db.alter_column(u'ils_record', 'publisher_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ils.Publisher'], null=True))

    def backwards(self, orm):

        # Changing field 'Record.publisher'
        db.alter_column(u'ils_record', 'publisher_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ils.Publisher']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Record', fields ['type']
        db.delete_unique(u'ils_record', ['type'])


    def backwards(self, orm):
        # Adding unique constraint on 'Record', fields ['type']
        db.create_unique(u'ils_record', ['type'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'ils_book', 'language')
        ...
        m2m_table_name = db.shorten_name(u'ils_book_subjects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm[u'ils.book'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ils_book', 'language',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=7, null=True, blank=True),
                      keep_default=False)
        ...
        db.delete_table(db.shorten_name(u'ils_book_subjects'))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Training.ends'
        db.alter_column(u'training_training', 'ends', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Training.starts'
        db.alter_column(u'training_training', 'starts', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Training.ends'
        db.alter_column(u'training_training', 'ends', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Training.starts'
        db.alter_column(u'training_training', 'starts', self.gf('django.db.models.fields.DateTimeField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.phone_no'
        db.add_column(u'training_organization', 'phone_no',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.email'
        db.add_column(u'training_organization', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.fax'
        db.add_column(u'training_organization', 'fax',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.website'
        db.add_column(u'training_organization', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.phone_no'
        db.delete_column(u'training_organization', 'phone_no')

        # Deleting field 'Organization.email'
        db.delete_column(u'training_organization', 'email')

        # Deleting field 'Organization.fax'
        db.delete_column(u'training_organization', 'fax')

        # Deleting field 'Organization.website'
        db.delete_column(u'training_organization', 'website')

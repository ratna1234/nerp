...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BudgetBalance', fields ['budget_head', 'fiscal_year']
        db.create_unique(u'core_budgetbalance', ['budget_head_id', 'fiscal_year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BudgetBalance', fields ['budget_head', 'fiscal_year']
        db.delete_unique(u'core_budgetbalance', ['budget_head_id', 'fiscal_year_id'])

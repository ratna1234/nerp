...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReceiptRow.tax_scheme'
        db.add_column(u'account_receiptrow', 'tax_scheme',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.TaxScheme']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReceiptRow.tax_scheme'
        db.delete_column(u'account_receiptrow', 'tax_scheme_id')
    ...
    models = {
        ...
        u'account.receiptrow': {
            ...
            'tax_scheme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.TaxScheme']"}),

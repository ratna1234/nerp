...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReceiptRow.budget'
        db.delete_column(u'account_receiptrow', 'budget_id')

        # Adding field 'ReceiptRow.budget_head'
        db.add_column(u'account_receiptrow', 'budget_head',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Budget']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReceiptRow.budget'
        db.add_column(u'account_receiptrow', 'budget',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Budget']),
                      keep_default=False)

        # Deleting field 'ReceiptRow.budget_head'
        db.delete_column(u'account_receiptrow', 'budget_head_id')
    ...
    models = {
        ...
        u'account.receiptrow': {
            ...
            'budget_head': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Budget']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receipt.date'
        db.add_column(u'account_receipt', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 3, 0, 0)),
                      keep_default=False)

        # Adding field 'Receipt.no'
        db.add_column(u'account_receipt', 'no',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'account_receipt', 'date')

        # Deleting field 'Receipt.no'
        db.delete_column(u'account_receipt', 'no')

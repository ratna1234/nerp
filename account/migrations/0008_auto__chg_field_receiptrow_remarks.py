...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReceiptRow.remarks'
        db.alter_column(u'account_receiptrow', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'ReceiptRow.remarks'
        db.alter_column(u'account_receiptrow', 'remarks', self.gf('django.db.models.fields.CharField')(default=None, max_length=254))

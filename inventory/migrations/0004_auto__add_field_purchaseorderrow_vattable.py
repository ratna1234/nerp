...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrderRow.vattable'
        db.add_column(u'inventory_purchaseorderrow', 'vattable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PurchaseOrderRow.vattable'
        db.delete_column(u'inventory_purchaseorderrow', 'vattable')

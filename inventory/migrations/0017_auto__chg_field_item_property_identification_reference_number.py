...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.property_identification_reference_number'
        db.alter_column(u'inventory_item', 'property_identification_reference_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Item.property_identification_reference_number'
        db.alter_column(u'inventory_item', 'property_identification_reference_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'property_identification_reference_number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),

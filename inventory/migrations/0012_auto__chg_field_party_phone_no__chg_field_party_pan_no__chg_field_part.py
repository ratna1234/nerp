...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_party', 'phone_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Party.pan_no'
        db.alter_column(u'inventory_party', 'pan_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Party.address'
        db.alter_column(u'inventory_party', 'address', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Party.phone_no'
        db.alter_column(u'inventory_party', 'phone_no', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))

        # Changing field 'Party.pan_no'
        db.alter_column(u'inventory_party', 'pan_no', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))

        # Changing field 'Party.address'
        db.alter_column(u'inventory_party', 'address', self.gf('django.db.models.fields.CharField')(default=None, max_length=254))

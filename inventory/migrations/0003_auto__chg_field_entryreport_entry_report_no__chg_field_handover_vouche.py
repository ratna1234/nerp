...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntryReport.entry_report_no'
        db.alter_column(u'inventory_entryreport', 'entry_report_no', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Handover.voucher_no'
        db.alter_column(u'inventory_handover', 'voucher_no', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'PurchaseOrder.order_no'
        db.alter_column(u'inventory_purchaseorder', 'order_no', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EntryReport.entry_report_no'
        db.alter_column(u'inventory_entryreport', 'entry_report_no', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'Handover.voucher_no'
        db.alter_column(u'inventory_handover', 'voucher_no', self.gf('django.db.models.fields.PositiveIntegerField')(default=None))

        # Changing field 'PurchaseOrder.order_no'
        db.alter_column(u'inventory_purchaseorder', 'order_no', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        u'inventory.entryreport': {
            ...
            'entry_report_no': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'fiscal_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.FiscalYear']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'inventory.handover': {
            ...
            'voucher_no': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'inventory.purchaseorder': {
            ...
            'fiscal_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.FiscalYear']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_no': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),

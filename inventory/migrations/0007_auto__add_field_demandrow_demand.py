...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DemandRow.demand'
        db.add_column(u'inventory_demandrow', 'demand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='rows', to=orm['inventory.Demand']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DemandRow.demand'
        db.delete_column(u'inventory_demandrow', 'demand_id')
    ...
    models = {
        ...
        u'inventory.demand': {
            ...
            'fiscal_year': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'inventory.demandrow': {
            ...
            'specification': ('django.db.models.fields.CharField', [], {'max_length': '254'}),

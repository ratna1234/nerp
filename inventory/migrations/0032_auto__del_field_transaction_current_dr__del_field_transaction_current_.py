...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.current_dr'
        db.delete_column(u'inventory_transaction', 'current_dr')

        # Deleting field 'Transaction.current_cr'
        db.delete_column(u'inventory_transaction', 'current_cr')

        # Adding field 'Transaction.current_balance'
        db.add_column(u'inventory_transaction', 'current_balance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transaction.current_dr'
        db.add_column(u'inventory_transaction', 'current_dr',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.current_cr'
        db.add_column(u'inventory_transaction', 'current_cr',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.current_balance'
        db.delete_column(u'inventory_transaction', 'current_balance')

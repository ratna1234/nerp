...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demand.fiscal_year'
        db.alter_column(u'inventory_demand', 'fiscal_year', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Demand.fiscal_year'
        db.alter_column(u'inventory_demand', 'fiscal_year', self.gf('django.db.models.fields.CharField')(max_length=5))

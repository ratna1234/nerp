...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Party.fiscal_year'
        db.delete_column(u'inventory_party', 'fiscal_year')

        # Adding field 'PurchaseOrder.fiscal_year'
        db.add_column(u'inventory_purchaseorder', 'fiscal_year',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Party.fiscal_year'
        db.add_column(u'inventory_party', 'fiscal_year',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)

        # Deleting field 'PurchaseOrder.fiscal_year'
        db.delete_column(u'inventory_purchaseorder', 'fiscal_year')

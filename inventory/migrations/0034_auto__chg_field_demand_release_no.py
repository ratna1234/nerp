...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demand.release_no'
        db.alter_column(u'inventory_demand', 'release_no', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Demand.release_no'
        db.alter_column(u'inventory_demand', 'release_no', self.gf('django.db.models.fields.IntegerField')(default=None))

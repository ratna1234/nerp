...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PurchaseOrderRow.budget_title_no'
        db.alter_column(u'inventory_purchaseorderrow', 'budget_title_no', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PurchaseOrderRow.budget_title_no'
        db.alter_column(u'inventory_purchaseorderrow', 'budget_title_no', self.gf('django.db.models.fields.IntegerField')(default=None))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DemandRow.specification'
        db.alter_column(u'inventory_demandrow', 'specification', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'DemandRow.remarks'
        db.alter_column(u'inventory_demandrow', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'DemandRow.specification'
        db.alter_column(u'inventory_demandrow', 'specification', self.gf('django.db.models.fields.CharField')(default=None, max_length=254))

        # Changing field 'DemandRow.remarks'
        db.alter_column(u'inventory_demandrow', 'remarks', self.gf('django.db.models.fields.CharField')(default=None, max_length=254))
    ...
    models = {
        ...
        u'inventory.item': {
            ...
            'unit': ('django.db.models.fields.CharField', [], {'default': "u'\\u0925\\u093e\\u0928'", 'max_length': '50'}),

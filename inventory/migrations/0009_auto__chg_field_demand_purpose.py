...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Demand.purpose'
        db.alter_column(u'inventory_demand', 'purpose', self.gf('django.db.models.fields.CharField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'Demand.purpose'
        db.alter_column(u'inventory_demand', 'purpose', self.gf('django.db.models.fields.TextField')())

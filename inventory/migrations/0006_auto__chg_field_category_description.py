...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_category', 'description', self.gf('django.db.models.fields.TextField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Category.description'
        db.alter_column(u'inventory_category', 'description', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

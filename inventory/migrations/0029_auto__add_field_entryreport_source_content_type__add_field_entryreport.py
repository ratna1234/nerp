...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryReport.source_content_type'
        db.add_column(u'inventory_entryreport', 'source_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'EntryReport.source_object_id'
        db.add_column(u'inventory_entryreport', 'source_object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryReport.source_content_type'
        db.delete_column(u'inventory_entryreport', 'source_content_type_id')

        # Deleting field 'EntryReport.source_object_id'
        db.delete_column(u'inventory_entryreport', 'source_object_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Handover.type'
        db.add_column(u'inventory_handover', 'type',
                      self.gf('django.db.models.fields.CharField')(default='Incoming', max_length=9),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Handover.type'
        db.delete_column(u'inventory_handover', 'type')

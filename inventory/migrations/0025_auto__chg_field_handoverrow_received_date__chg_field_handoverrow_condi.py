...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HandoverRow.received_date'
        db.alter_column(u'inventory_handoverrow', 'received_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HandoverRow.condition'
        db.alter_column(u'inventory_handoverrow', 'condition', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'HandoverRow.received_date'
        db.alter_column(u'inventory_handoverrow', 'received_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'HandoverRow.condition'
        db.alter_column(u'inventory_handoverrow', 'condition', self.gf('django.db.models.fields.TextField')(default=None))

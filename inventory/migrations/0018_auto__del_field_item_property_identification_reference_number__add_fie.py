...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.property_identification_reference_number'
        db.delete_column(u'inventory_item', 'property_identification_reference_number')

        # Adding field 'Item.property_classification_reference_number'
        db.add_column(u'inventory_item', 'property_classification_reference_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.property_identification_reference_number'
        db.add_column(u'inventory_item', 'property_identification_reference_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Item.property_classification_reference_number'
        db.delete_column(u'inventory_item', 'property_classification_reference_number')

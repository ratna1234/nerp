...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_demand', (
            ...
            ('release_no', self.gf('django.db.models.fields.IntegerField')()),
            ('fiscal_year', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ...
        db.create_table(u'inventory_demandrow', (
            ...
            ('specification', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('quantity', self.gf('django.db.models.fields.FloatField')()),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('release_quantity', self.gf('django.db.models.fields.FloatField')()),

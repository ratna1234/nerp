...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Handover.voucher_no'
        db.add_column(u'inventory_handover', 'voucher_no',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Handover.voucher_no'
        db.delete_column(u'inventory_handover', 'voucher_no')

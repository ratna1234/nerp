...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DemandRow.status'
        db.add_column(u'inventory_demandrow', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Requested', max_length=9),
                      keep_default=False)

        # Deleting field 'Demand.status'
        db.delete_column(u'inventory_demand', 'status')


    def backwards(self, orm):
        # Deleting field 'DemandRow.status'
        db.delete_column(u'inventory_demandrow', 'status')

        # Adding field 'Demand.status'
        db.add_column(u'inventory_demand', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Requested', max_length=9),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InventoryAccountRow.inventory_account'
        db.delete_column(u'inventory_inventoryaccountrow', 'inventory_account_id')

        # Adding field 'InventoryAccountRow.journal_entry'
        db.add_column(u'inventory_inventoryaccountrow', 'journal_entry',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='account_row', unique=True, to=orm['inventory.JournalEntry']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InventoryAccountRow.inventory_account'
        db.add_column(u'inventory_inventoryaccountrow', 'inventory_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['inventory.InventoryAccount']),
                      keep_default=False)

        # Deleting field 'InventoryAccountRow.journal_entry'
        db.delete_column(u'inventory_inventoryaccountrow', 'journal_entry_id')
    ...
    models = {
        ...
        u'inventory.journalentry': {
            ...
            'country_of_production': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),

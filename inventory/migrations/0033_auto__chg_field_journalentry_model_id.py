...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JournalEntry.model_id'
        db.alter_column(u'inventory_journalentry', 'model_id', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'JournalEntry.model_id'
        db.alter_column(u'inventory_journalentry', 'model_id', self.gf('django.db.models.fields.IntegerField')())

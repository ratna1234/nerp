...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DemandRow.release_quantity'
        db.alter_column(u'inventory_demandrow', 'release_quantity', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'DemandRow.release_quantity'
        db.alter_column(u'inventory_demandrow', 'release_quantity', self.gf('django.db.models.fields.FloatField')(default=None))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryAccount.current_balance'
        db.add_column(u'inventory_inventoryaccount', 'current_balance',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InventoryAccount.current_balance'
        db.delete_column(u'inventory_inventoryaccount', 'current_balance')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_entryreportrow', (
            ...
            ('other_expenses', self.gf('django.db.models.fields.FloatField')()),
            ('remarks', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('entry_report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.EntryReport'])),
        ))
        db.send_create_signal(u'inventory', ['EntryReportRow'])


        # Changing field 'HandoverRow.sn'
        db.alter_column(u'inventory_handoverrow', 'sn', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'DemandRow.sn'
        db.alter_column(u'inventory_demandrow', 'sn', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'PurchaseOrderRow.sn'
        db.alter_column(u'inventory_purchaseorderrow', 'sn', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HandoverRow.sn'
        db.alter_column(u'inventory_handoverrow', 'sn', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DemandRow.sn'
        db.alter_column(u'inventory_demandrow', 'sn', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PurchaseOrderRow.sn'
        db.alter_column(u'inventory_purchaseorderrow', 'sn', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'inventory.entryreportrow': {
            ...
            'entry_report': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.EntryReport']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Item']"}),
            'other_expenses': ('django.db.models.fields.FloatField', [], {}),
            'quantity': ('django.db.models.fields.FloatField', [], {}),
